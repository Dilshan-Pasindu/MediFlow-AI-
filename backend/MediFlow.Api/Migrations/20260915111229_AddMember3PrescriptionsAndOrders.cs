...
{
    /// <inheritdoc />
    public partial class AddMember3PrescriptionsAndOrders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalkInPatientAge = table.Column<string>(type: "text", nullable: true),
                    WalkInPatientGender = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_Orders_MedicineOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_MedicineOrderId",
                table: "OrderItems",
