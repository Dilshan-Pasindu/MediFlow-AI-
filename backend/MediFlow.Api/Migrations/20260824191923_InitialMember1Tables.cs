...
{
    /// <inheritdoc />
    public partial class InitialMember1Tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentNumber = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendedSpecialty = table.Column<string>(type: "text", nullable: true),
                    RecommendationConfidence = table.Column<decimal>(type: "numeric", nullable: true),
                    AgentExplanation = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SymptomSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SymptomSubmissions_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SymptomSubmissions_PatientId",
                table: "SymptomSubmissions",
                column: "PatientId");
